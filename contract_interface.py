...
with open(os.path.join(dirname,"solidity/abi_Product.json"), "r") as file:
    abi = file.read()

# Retrieve address of our smart contract
with open(os.path.join(dirname,"solidity/contract_address_Product"), "r") as file:
    contract_address = file.read()


with open(os.path.join(dirname,"config/blockchain_network"), "r") as f:
